...
def get_args_parser():
    ...
    parser.add_argument('--enable_adaptive_pseudo', action='store_true')
    parser.add_argument('--pseudo_store_path', default='exps/loss_memory', type=str)
    parser.add_argument('--adaptive_update_Iter', default=300, type=int)
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.output_dir:
            ...
            # extra checkpoint before LR drop and every 3 epochs
