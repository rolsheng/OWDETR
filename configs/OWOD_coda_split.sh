...
python -u main_open_world.py \
    ...
    --PREV_INTRODUCED_CLS 0 --CUR_INTRODUCED_CLS 4 --train_set 't1_train' --test_set 'test'  \
...
python -u main_open_world.py \
    --output_dir ${EXP_DIR}  --eval_every 1 \
    --PREV_INTRODUCED_CLS 4 --CUR_INTRODUCED_CLS 11 --train_set 't2_train' --test_set 'test'  \
...
python -u main_open_world.py \
    --output_dir ${EXP_DIR} --eval_every 1 \
    --PREV_INTRODUCED_CLS 4 --CUR_INTRODUCED_CLS 11 --train_set 't2_ft' --test_set 'test' \
...
python -u main_open_world.py \
    --output_dir ${EXP_DIR}  --eval_every 1 \
    --PREV_INTRODUCED_CLS 15 --CUR_INTRODUCED_CLS 7  --train_set 't3_train' --test_set 'test' \
...
python -u main_open_world.py \
    --output_dir ${EXP_DIR} --eval_every 1 \
    --PREV_INTRODUCED_CLS 15 --CUR_INTRODUCED_CLS 7  --train_set 't3_ft' --test_set 'test' \
...
python -u main_open_world.py \
    --output_dir ${EXP_DIR} --eval_every 1 \
    --PREV_INTRODUCED_CLS 22 --CUR_INTRODUCED_CLS 8 --train_set 't4_train' --test_set 'test' \
...
python -u main_open_world.py \
    --output_dir ${EXP_DIR} --eval_every 1 \
    --PREV_INTRODUCED_CLS 22 --CUR_INTRODUCED_CLS 8  --train_set 't4_ft' --test_set 'test' \
